...
<div class="container" >
<h1><?php echo $data; ?> </h1>
<form action="<?php echo base_url().'index.php/DNA_Analysis/save';?>" method="post">
<table>

	<div class="col-xs-4">
		 <label for="Details">Analysis Details</label>
         <input class="form-control" id="ex3" type="text" name="fte_name" placeholder="Analysis Details">
