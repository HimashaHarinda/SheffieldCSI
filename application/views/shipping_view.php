...
<div class="container">
<h1><?php echo $data; ?> </h1>
<form action="<?php echo base_url().'index.php/shipping/save';?>" method="post">
<table>

	
    <div class="col-xs-4">
		 <label for="destination">Shipping Destination</label>
         <input class="form-control" id="ex3" type="text" name="shipping_destination" placeholder="Shipping Destination">
	...
	<div class="col-xs-4">
		...
		<input class="form-control" id="ex3" type="text" name="shipping_date" placeholder="yyyy-mm-dd">
